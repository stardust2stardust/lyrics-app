...
const SearchResults = ({ results }) => {
  console.log("results passed to SearchResults component: ", results);
  const songList = results?.data;

  return (
    <div>
      <h2 className="text-primary text-center">Search Results will go here.</h2>
      {results && (
        <ul>
          {songList.map((item) => (
            <li>
